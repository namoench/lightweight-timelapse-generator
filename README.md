...
I create a lot of timelapses of the night sky, it was getting tedious sorting all the photos from my SD card and then remembering the FFMPEG comamnds I need every time, so I built this tiny little FFMPEG timelapse generation app to live in the menu bar of my macbook. Feel free to do whatever you'd like with it, hope it helps! 
